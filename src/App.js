...
import LicenseCenter from "./Components/CenterModule/LicenseCenter";
...
function App() { 
  ...
  return (
    ...
    <Routes>
      ...
      settoggleDark={settoggleDark}/>}> </Route>
      <Route path="/LicenseCenter" element={< LicenseCenter changeLanguage={changeLanguage} toggleDark={toggleDark}
      settoggleDark={settoggleDark}/>}> </Route>
    </Routes>
  </BrowserRouter>
